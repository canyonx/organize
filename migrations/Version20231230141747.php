...
final class Version20231230141747 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE trip (id INT NOT NULL, member_id INT NOT NULL, activity_id INT NOT NULL, title VARCHAR(50) NOT NULL, date_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, description TEXT DEFAULT NULL, lat VARCHAR(10) NOT NULL, lng VARCHAR(10) NOT NULL, PRIMARY KEY(id))');
